...
function createConfig(): AppConfig {
	...
	const oneTrustResult = oneTrustSchema.safeParse(
		process.env.NEXT_PUBLIC_ONETRUST_DOMAIN_ID,
	);
	const oneTrustDomainId = oneTrustResult.success
		? oneTrustResult.data
		: undefined;
	...
	const piwikInput =
		rawPiwikId || rawPiwikUrl
			? { containerId: rawPiwikId, containerUrl: rawPiwikUrl }
			: undefined;
...
export const config: AppConfig = deepFreeze(createConfig());
